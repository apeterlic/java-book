...
do {
    ...
    scanner.nextLine();
        ...
        System.out.println("You chose door " + (initialChoice + 1) + ". Behind door " + (revealedDoor + 1) + " is a goat. Do you want to stay (S) or switch (SW)?");
        ...
        System.out.println("You chose door " + (finalChoice + 1) + ". Behind door " + (prizePosition + 1) + " is " + (prizePosition == finalChoice ? "a car! Congratulations!" : "a goat. Better luck next time."));
